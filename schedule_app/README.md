...
2. Убедитесь, что файл entrypoint.sh имеет права на выполнение:
...
### Проблема: Сайт недоступен по адресу http://localhost:8000
...
2. Попробуйте обратиться к сайту по адресу http://localhost

3. Проверьте логи контейнера frontend:
...
4. Дополнительные функции:
   ...
   - экспорт расписания в различные форматы (PDF, Excel и т. п.).
